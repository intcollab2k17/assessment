...
<head>
<meta charset="utf-8"/>
<title><?php include('title.php');?> | Faculty</title>
				...
				<div class="col-md-12">
					...
					<div class="profile-content">
						...
						<div class="portlet-body">
							...
							<tbody>
<?php
	$query1=mysqli_query($con,"select * from member where member_type='Faculty' order by member_last")or die(mysqli_error());
									...
									<!-- BEGIN SAMPLE FORM PORTLET-->
										<div class="portlet light">
											<div class="portlet-title">
												<div class="caption font-red-sunglo">
													<i class=" icon-notebook font-red-sunglo"></i>
													<span class="caption-subject bold uppercase"> Add Faculty</span>
												</div>
											</div>
											<div class="portlet-body form">
